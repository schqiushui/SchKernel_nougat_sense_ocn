...
#define dev_vdbg(dev, format, arg...)		\
	_dev_info(dev, "[TP][VD] "format, ##arg)
#endif
#endif
...
#define htc_dev_err(dev, format, arg...)		\
	dev_printk(KERN_ERR, dev, "[TP][E] "format, ##arg)


#define htc_tamper_fs_print(dev, format, arg...) \
({\
	struct cyttsp5_platform_data *_pdata = dev_get_platdata(dev);\
	if( dev && _pdata && _pdata->core_pdata &&\
		_pdata->core_pdata->htc_tamper_sf == 0 ) {\
			pr_info(format, arg);\
	}\
})
...
#define HTC_CYTTSP5_SYSFS_PATH          "/sys/android_touch/"
#define HTC_CYTTSP5_DEBUGFS_PATH        "/sys/kernel/debug/android_touch/mfg_test/"
#define HTC_CYTTSP5_DEBUFFS_PANEL_SCAN  HTC_CYTTSP5_DEBUGFS_PATH"panel_scan"
#define HTC_CYTTSP5_DEBUFFS_CM_PANEL    HTC_CYTTSP5_DEBUGFS_PATH"cm_panel"
#define HTC_CYTTSP5_DEBUFFS_CP_PANEL    HTC_CYTTSP5_DEBUGFS_PATH"cp_panel"

#define HTC_PANEL_5_DOT_5_FW_REV (877132)
#define HTC_PANEL_5_DOT_2_FW_REV (880008)
//htc-
...
//#define CONFIG_YUDE_MTK //htc
//#define USE_I2C_DMA
#define TTHE_TUNER_SUPPORT //htc: request by vendor to debug firmware update
...
#define CY_HID_RESET_TIMEOUT			200
...
#else
#define CY_HID_GET_HID_DESCRIPTOR_RETRY		4
...
//htc++
#define CY_HID_SET_POWER_RETRY			3
#define CY_HID_SET_MODE_RETRY			3
//htc--
#ifdef VERBOSE_DEBUG
...
enum cyttsp5_tch_hdr {
	...
	CY_TCH_HOPPING_FREQ, //htc: RESERVED FIELD, SAME OFS as NOISE EFFECT
...
static const int cyttsp5_tch_hdr_field_map[] = {
	...
	[CY_TCH_HOPPING_FREQ] = 0, //htc: RESERVED FIELD, SAME OFS as NOISE EFFECT
...
#else
#define CY_NUM_EXT_TCH_FIELDS   0
#endif
...
#endif
//htc++
	struct workqueue_struct *resume_suspend_wq;
